...
class GildedRoseTest(unittest.TestCase):
    def test_name(self):
        items = [Item(Object_type.BASE_ITEM, 0, 0)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(Object_type.BASE_ITEM, items[0].name)

    def test_updated_properties_normal_item_before_selling(self):
        items = [Item(Object_type.BASE_ITEM, 10, 10)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_updated_properties_normal_item_after_sellin_expires(self):
        items = [Item(Object_type.BASE_ITEM, 0, 10)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_quality_increase_for_aged_brie_before_sellin(self):
        items = [Item(Object_type.BRIE, 1, 10)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_quality_increase_for_aged_brie_after_sellin(self):
        items = [Item(Object_type.BRIE, 0, 20)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_quality_not_greater_than_50(self):
        items = [Item(Object_type.BRIE, 0, 50)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_sulfuras_never_changes_properties(self):
        items = [Item(Object_type.SULFURAS, 12, 23)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_backstage_passes_with_more_than_5_days_but_less_than_10(self):
        items = [Item(Object_type.TICKETS, 12, 23)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_backstage_passes_with_less_than_10_days(self):
        items = [Item(Object_type.TICKETS, 8, 23)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_backstage_passes_with_less_than_5_days(self):
        items = [Item(Object_type.TICKETS, 4, 23)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_backstage_passes_day_of_the_concert(self):
        items = [Item(Object_type.TICKETS, 0, 23)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(0, items[0].quality)
        self.assertEqual(-1, items[0].sell_in)
    ...
    def test_backstage_passes_day_after_concert(self):
        items = [Item(Object_type.TICKETS, -2, 23)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(0, items[0].quality)
        self.assertEqual(-3, items[0].sell_in)
    ...
    def test_repr(self):
        ...
        self.assertEqual(representation, str(Object_type.BASE_ITEM) + ", 10, 10")

    def test_initial_quality_cant_be_over_50(self):
        items = [Item(Object_type.BASE_ITEM, 5, 58)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_negative_sellin_from_the_start(self):
        items = [Item(Object_type.BASE_ITEM, -3, 20)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test__brie_quality_upper_bound(self):
        items = [Item(Object_type.BRIE, 0, 49)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(50, items[0].quality)
        self.assertEqual(-1, items[0].sell_in)

    def test__backstage_tickets_quality_uppber_bound_more_than_5_but_less_than_10(self):
        items = [Item(Object_type.TICKETS, 8, 49)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(50, items[0].quality)
        self.assertEqual(7, items[0].sell_in)

    def test__backstage_tickets_quality_upper_bound_less_than_5_days_left(self):
        items = [Item(Object_type.TICKETS, 2, 49)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(50, items[0].quality)
        self.assertEqual(1, items[0].sell_in)
    ...
    def test_quality_cant_be_negative_when_creating_the_object(self):
        items = [Item(Object_type.BASE_ITEM, 20, -3)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(0, items[0].quality)
    ...
    def test_conjured(self):
        items = [Item(Object_type.CONJURED, 5, 10)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(8, items[0].quality)
        self.assertEqual(4, items[0].sell_in)
    ...
    def test_bad_item(self):
        items = [Item(Object_type.BAD, 2, 0)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_bad_item_lower_bound(self):
        items = [Item(Object_type.BAD, 0, 0)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        gilded_rose.update_quality()
        gilded_rose.update_quality()
    ...
    def test_milk_lower_bound(self):
        items = [Item(Object_type.MILK, 0, 0)]
        gilded_rose = GildedRose(items)
        for i in range(30):
            gilded_rose.update_quality()
        self.assertEqual(-50, items[0].quality)
